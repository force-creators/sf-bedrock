...
export default class EventLayout extends LightningElement {
    ...
    get isSelectedErrorActionDisabled() {
        return (
            this.isRefreshing ||
            this.isApplyingErrorAction ||
            !this.hasSelectedErrorRows
        );
    }
    ...
    handleBacklogSort(event) {
        ...
        this.backlogRows = this.sortRows(
            this.backlogRows,
            this.backlogSortBy,
            this.backlogSortDirection
        );
    }
    ...
    handleErrorSort(event) {
        ...
        this.errorRows = this.sortRows(
            this.errorRows,
            this.errorSortBy,
            this.errorSortDirection
        );
    }
    ...
    handleArchiveSort(event) {
        ...
        this.archiveRows = this.sortRows(
            this.archiveRows,
            this.archiveSortBy,
    ...
    async refreshAll() {
        ...
        try {
            ...
            this.configRows = this.sortRows(
                state.configRows || [],
                this.configSortBy,
                this.configSortDirection
            );
    ...
    reduceErrors(error) {
        ...
        return (
            error?.body?.message ||
            error?.message ||
            "Unable to load EventRelay publish work."
        );
    }
}
